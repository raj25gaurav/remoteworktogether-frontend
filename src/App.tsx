  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      <div className="app-layout" style={{ position: 'relative', zIndex: 1 }}>
        {/* Left Sidebar */}
        <Sidebar send={send} currentRoomId={currentRoomId} />
        ...
        <div className="main-content">
          ...
          <div className="topbar">
            ...
            <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
              ...
              {/* Toggle panels */}
              <button className={`btn btn-sm ${showChat ? 'btn-primary' : 'btn-ghost'}`} onClick={toggleChat}>
                💬
              </button>
              <button className={`btn btn-sm ${showAIPanel ? 'btn-primary' : 'btn-ghost'}`} onClick={toggleAIPanel}>
                🤖
              </button>
            </div>
          </div>
